...
- [ ] Step 5 Group 2B — child rows, sidebar parent/related rows, and recommendation entity thumbnails on the shared fallback contract; parent-image substitution removed as an approved fallback shortcut; preserve all frames, crop modes, navigation, analytics, and user initials; verify then stop before later groups
