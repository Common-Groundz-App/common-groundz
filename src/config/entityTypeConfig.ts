...
export const entityTypeConfig: Record<string, EntityTypeConfig> = {
  ...
  service: {
    ...
    fieldGroups: [
      { title: 'Service Details', icon: '🛠️', fields: ['service_category', 'provider_name', 'service_areas', 'pricing_model', 'target_audience'] },
  ...
  professional: {
    ...
    fieldGroups: [
      { title: 'Professional Info', icon: '👨‍⚕️', fields: ['profession', 'specialty', 'years_experience', 'education'] },
  ...
  generic: {
    showTabs: ['basic'],
    hideTabs: ['contact', 'hours', 'details'],
    requiredFields: [],
    fields: [
