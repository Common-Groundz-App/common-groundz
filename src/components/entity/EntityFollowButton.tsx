...
export const EntityFollowButton: React.FC<EntityFollowButtonProps> = ({
  ...
  return (
    <Button 
      ...
      className={`${textClass} ${
        isFollowing 
          ? `${isHovering ? 'border-red-500 text-red-500 bg-transparent hover:bg-red-50 dark:hover:bg-red-500/10' : 'border-brand-orange text-brand-orange bg-brand-orange/10 hover:bg-brand-orange/15'} transition-colors duration-200` 
