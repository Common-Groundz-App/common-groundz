...
export const ReviewsSection: React.FC<ReviewsSectionProps> = ({ entityId, entityName }) => {
                ...
                <div className="flex-1">
                  ...
                  <div className="space-y-4">
                    <div className="border-l-2 border-gray-200 pl-4">
                      ...
                      <p className="text-gray-700">Started using {entityName} whey protein. Initial impressions are good.</p>
                    </div>
                    <div className="border-l-2 border-gray-200 pl-4">
