...
import { HomeItem } from '@/hooks/home/types';
...
interface RecommendationHomeItemProps {
  recommendation: HomeItem;
...
export const RecommendationHomeItem: React.FC<RecommendationHomeItemProps> = ({ 
  recommendation, 
  onLike, 
  onSave,
  onComment,
...
export default RecommendationHomeItem;
