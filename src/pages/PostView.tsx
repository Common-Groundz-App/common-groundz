  ...
  if (!user) {
    return (
      <div className="min-h-screen flex flex-col">
        ...
        />
        <GuestNavBar />
        <div className="flex-1 container max-w-3xl mx-auto pt-2 pb-6 sm:py-6 px-0 sm:px-4">
          {isOwner && (
    ...
    <div className="min-h-screen flex flex-col pb-[calc(4rem+env(safe-area-inset-bottom))] xl:pb-0">
      ...
      <div className="flex flex-1">
        ...
        <div className="flex-1 pt-16 xl:pt-0 xl:ml-64 min-w-0">
          ...
          <div className="w-full mx-auto grid justify-center xl:grid-cols-7 gap-4 px-0 sm:px-4 pt-2 pb-6 sm:py-6">
            {/* Left spacer */}
